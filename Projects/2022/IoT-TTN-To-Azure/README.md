...
<h3>Azure IoT Central App (spsepn-iotc)</h3>

https://spsepn-iotc.azureiotcentral.com/
...
Now, we can create a HttpTriggerTTNtoIoTC function deploying its code in the Azure Portal. The files can be found in the folder xxxxxxxxxx
