        ...
        public static void Main()
        {
            ...
            button.Press += (sender, e) =>
            {
                ...
                try
                {
                    ...
                    tmp_hum.Temp = (float)data.Temperature.DegreesCelsius;
                    tmp_hum.Hum = (float)data.RelativeHumidity.Percent;
            ...
            while (true)//this is not good, but that is how it is done fast (DOD is tomorow)
            {
                Sht4XSensorData data = null;
                ...
                lora.SendAsync(0, json);
                Debug.WriteLine(json);
                Blink.Blinks(0, 0, 255, 1000, 0.5, 1);
                Thread.Sleep(5000);
            }
