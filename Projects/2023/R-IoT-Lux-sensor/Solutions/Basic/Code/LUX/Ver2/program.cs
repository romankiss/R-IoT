...
namespace Projekt_26._12._2023
{
    public class Program
    {
        ...
        static Bh1750fvi sensor = null;
        static double illuminance = 0;
        public static void Main()
        {
            ...
            display = new Iot.Device.Ssd13xx.Ssd1306(i2c_oled128x64);
            sensor = new Bh1750fvi(device);

            display.Font = new Sinclair8x8();
            display.ClearScreen();

            button.Press += (sender, e) => Lux();
